...
Any time you set up a new Samourai Wallet, you will be asked if you want to `Claim your PayNym`. If you already have a Samourai Wallet and haven’t yet used your PayNym, simply tap the blue **+** on the home screen and then hit `PayNyms.` From here you can see a list of the Nyms you currently follow and the Nyms that follow you. You can also open your QR code scanner to follow a new PayNym contact. _(This can also be done by pasting in the raw payment code)._
