# allprivatekeys.com -- Scraped Content
...
Bitcoin address is an identifier (like account number),  
starting with 1, 3 or bc1 on the mainnet, containing   
27-34 alphanumeric Latin characters and digits (except 0, O, I).

Also set to Bitcoin Cash mainnet, bchtest for testnet and bchreg for bitcoin cash regtest.
...
There are currently three address formats in use in Bitcoin mainnet:  
  ...
  3. [Bech32](https://en.bitcoin.it/wiki/Bech32 "Bech32") type starting with bc1. 
...
---|---|---  
Pubkey hash ([P2PKH address](https://en.bitcoin.it/wiki/Transaction#Pay-to-PubkeyHash "Transaction")) | 1 | 17VZNX1SN5NtKa8UQFxwQbFeFc3iqRYhem  
Script hash ([P2SH address](https://en.bitcoin.it/wiki/Pay_to_script_hash "Pay to script hash")) SegWit Pay 2 Witness Public Key Hash ([P2SH-P2WPKH](https://github.com/bitcoin/bips/blob/master/bip-0141.mediawiki#P2WPKH)) | 3 | 3EktnHQD7RiAE6uzMj2ZifT9YgRrkSgzQX  
...
Private key ([WIF](https://en.bitcoin.it/wiki/Wallet_import_format "Wallet import format"), uncompressed pubkey) | 5 | 5Hwgr3u458GLafKBgxtssHSPqJnYoGrSzgQsPwLFhLNYskDPyyA  
Private key ([WIF](https://en.bitcoin.it/wiki/Wallet_import_format "Wallet import format"), compressed pubkey) | K  _or_ L | L1aW4aubDFB7yfras2S1mN3bqg9nwySY8nkoLmJebSLD5BWv3ENZ  
[BIP32](https://en.bitcoin.it/wiki/BIP_0032 "BIP 0032") pubkey | xpub | xpub661MyMwAqRbcEYS8w7XLSVeEsBXy79zSzH1J8vCdxAZningWLdN3 zgtU6LBpB85b3D2yc8sfvZU521AAwdZafEz7mnzBBsz4wKY5e4cp9LB  
[BIP32](https://en.bitcoin.it/wiki/BIP_0032 "BIP 0032") private key | xprv | xprv9s21ZrQH143K24Mfq5zL5MhWK9hUhhGbd45hLXo2Pq2oqzMMo63o StZzF93Y5wvzdUayhgkkFoicQZcP3y52uPPxFnfoLZB21Teqt1VvEHx  
Testnet pubkey hash | m  _or_ n | mipcBbFg9gMiCh81Kj8tqqdgoZub1ZJRfn  
