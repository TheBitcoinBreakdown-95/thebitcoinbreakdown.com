# 8.7 Energy Money -- Scraped Source Content

## Metadata
- **Purpose:** Full extracted text from each scraped link, keyed by link # from `links.md`
- **Status:** 0 DONE, 0 PARTIAL, 2 FAILED, 2 SKIPPED
- **Last updated:** April 11, 2026

---

## Extracted Content
### Link #1 -- "Jordan Peterson's Mind Blown By Bitcoin Mining & Energy -- Orange Pilled By Saifedean" -- BITCOIN channel

**Source:** www.youtube.com
**URL:** https://www.youtube.com/watch?v=am7L648-ML0
**Type:** YouTube
**Scrape status:** SKIPPED (YouTube (oEmbed failed))

---

*No content extracted. Reason: YouTube (oEmbed failed)*


---

### Link #2 -- "Bitcoin Well Theory" -- academic paper on Bitcoin and energy

**Source:** zenodo.org
**URL:** https://zenodo.org/records/14686888/files/Bitcoin_Well_Theory%20(17).pdf?download=1
**Type:** PDF
**Scrape status:** SKIPPED (Direct file download (.pdf))

---

*No content extracted. Reason: Direct file download (.pdf)*
