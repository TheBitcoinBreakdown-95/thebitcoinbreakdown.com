# 8.12 Total Addressable Market -- Scraped Source Content

## Metadata
- **Purpose:** Full extracted text from each scraped link, keyed by link # from `links.md`
- **Status:** 1 DONE, 0 PARTIAL, 1 FAILED, 0 SKIPPED
- **Last updated:** April 11, 2026

---

## Extracted Content
### Link #1 -- Anil Saidso -- Bitcoin TAM: three categories of market disruption

**Source:** x.com
**URL:** https://x.com/anilsaidso/status/1673819021492506624?s=46
**Type:** Twitter/X
**Scrape status:** DONE
